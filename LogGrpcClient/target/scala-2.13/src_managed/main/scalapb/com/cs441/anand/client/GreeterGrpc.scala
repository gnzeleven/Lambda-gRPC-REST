...
object GreeterGrpc {
  val METHOD_SAY_HELLO: _root_.io.grpc.MethodDescriptor[com.cs441.anand.client.HelloRequest, com.cs441.anand.client.HelloReply] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[com.cs441.anand.client.HelloRequest])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[com.cs441.anand.client.HelloReply])
      .setSchemaDescriptor(_root_.scalapb.grpc.ConcreteProtoMethodDescriptorSupplier.fromMethodDescriptor(com.cs441.anand.client.ClientProto.javaDescriptor.getServices().get(0).getMethods().get(0)))
      .build()
  
  val SERVICE: _root_.io.grpc.ServiceDescriptor =
    _root_.io.grpc.ServiceDescriptor.newBuilder("com.cs441.anand.Greeter")
      .setSchemaDescriptor(new _root_.scalapb.grpc.ConcreteProtoFileDescriptorSupplier(com.cs441.anand.client.ClientProto.javaDescriptor))
  ...
  trait Greeter extends _root_.scalapb.grpc.AbstractService {
    ...
    /** Sends a greeting
      */
    def sayHello(request: com.cs441.anand.client.HelloRequest): scala.concurrent.Future[com.cs441.anand.client.HelloReply]
  }
  ...
  object Greeter extends _root_.scalapb.grpc.ServiceCompanion[Greeter] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.ServiceDescriptor = com.cs441.anand.client.ClientProto.javaDescriptor.getServices().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.ServiceDescriptor = com.cs441.anand.client.ClientProto.scalaDescriptor.services(0)
    def bindService(serviceImpl: Greeter, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
      ...
      .addMethod(
        METHOD_SAY_HELLO,
        _root_.io.grpc.stub.ServerCalls.asyncUnaryCall(new _root_.io.grpc.stub.ServerCalls.UnaryMethod[com.cs441.anand.client.HelloRequest, com.cs441.anand.client.HelloReply] {
          override def invoke(request: com.cs441.anand.client.HelloRequest, observer: _root_.io.grpc.stub.StreamObserver[com.cs441.anand.client.HelloReply]): Unit =
  ...
  trait GreeterBlockingClient {
    ...
    /** Sends a greeting
      */
    def sayHello(request: com.cs441.anand.client.HelloRequest): com.cs441.anand.client.HelloReply
  }
  ...
  class GreeterBlockingStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterBlockingStub](channel, options) with GreeterBlockingClient {
    /** Sends a greeting
      */
    override def sayHello(request: com.cs441.anand.client.HelloRequest): com.cs441.anand.client.HelloReply = {
  ...
  class GreeterStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterStub](channel, options) with Greeter {
    /** Sends a greeting
      */
    override def sayHello(request: com.cs441.anand.client.HelloRequest): scala.concurrent.Future[com.cs441.anand.client.HelloReply] = {
