...
object GreeterGrpc {
  val METHOD_DISPLAY_TIME: _root_.io.grpc.MethodDescriptor[com.cs441.anand.client.TimeRequest, com.cs441.anand.client.TimeReply] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[com.cs441.anand.client.TimeRequest])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[com.cs441.anand.client.TimeReply])
  ...
  trait Greeter extends _root_.scalapb.grpc.AbstractService {
    ...
    /** Sends a greeting
      */
    def displayTime(request: com.cs441.anand.client.TimeRequest): scala.concurrent.Future[com.cs441.anand.client.TimeReply]
  }
  ...
  object Greeter extends _root_.scalapb.grpc.ServiceCompanion[Greeter] {
    ...
    def bindService(serviceImpl: Greeter, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
      ...
      .addMethod(
        METHOD_DISPLAY_TIME,
        _root_.io.grpc.stub.ServerCalls.asyncUnaryCall(new _root_.io.grpc.stub.ServerCalls.UnaryMethod[com.cs441.anand.client.TimeRequest, com.cs441.anand.client.TimeReply] {
          override def invoke(request: com.cs441.anand.client.TimeRequest, observer: _root_.io.grpc.stub.StreamObserver[com.cs441.anand.client.TimeReply]): Unit =
  ...
  trait GreeterBlockingClient {
    ...
    /** Sends a greeting
      */
    def displayTime(request: com.cs441.anand.client.TimeRequest): com.cs441.anand.client.TimeReply
  }
  ...
  class GreeterBlockingStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterBlockingStub](channel, options) with GreeterBlockingClient {
    /** Sends a greeting
      */
    override def displayTime(request: com.cs441.anand.client.TimeRequest): com.cs441.anand.client.TimeReply = {
  ...
  class GreeterStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterStub](channel, options) with Greeter {
    /** Sends a greeting
      */
    override def displayTime(request: com.cs441.anand.client.TimeRequest): scala.concurrent.Future[com.cs441.anand.client.TimeReply] = {
